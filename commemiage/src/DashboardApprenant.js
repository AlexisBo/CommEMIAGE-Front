...
class DashboardApprenant extends Component {
                    ...
                    <div className="col-md-4">
                        <div className="card">
                            ...
                            <div className="card-body form-group">                                                    
                                <select id="semestre" className="form-control" name="semestre">
                                    <option>Semestre 1 2018</option>
                                    <option>Semestre 2 2018</option>
                                    <option>Semestre 1 2019</option>
                                    <option>Semestre 2 2019</option>
                                    <option>Semestre 1 2020</option>
                                    <option>Semestre 2 2020</option>
                                </select>  
                            </div>
                        </div>
